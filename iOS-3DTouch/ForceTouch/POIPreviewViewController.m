...
- (void)initTableView
{
    ...
    titleLabel.textColor = [UIColor colorWithRed:1 green:41.0/255 blue:21.0/255 alpha:1];
    ...
    typeLabel.textColor = [UIColor colorWithRed:1 green:41.0/255 blue:21.0/255 alpha:1];
